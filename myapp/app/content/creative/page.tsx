...
export const metadata = {
  title: "Creative Courses | CertificateAI",
  description: "Develop your creative skills in design, video, photography, and more.",
};

export default function CreativePage({ searchParams }: Props) {
  const allCourses = getCoursesByCategory("creative");
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <ContentHero category="creative" />

      <Suspense fallback={null}>
        <ContentSubNav items={subCategories.creative} />
      </Suspense>
        ...
        {!sub && (
          <div className="pt-8 pb-2">
            ...
            <p className="text-sm text-gray-500">
              Highly rated courses loved by our creative community
            </p>
          </div>
        )}
